package com.movitech.framework.views;
 ...
 * @Created Time: Oct 21, 2014, 10:33:39 AM
 * @Description: DotPageIndicator是给ViewPager显示个数以及当前所在界面的圆点标记控件
 *
 **/
...
public class DotPageIndicator extends View implements PageIndicator {
    ...
    public DotPageIndicator(Context context, AttributeSet attrs) {
        ...
        final int defaultPageColor = res.getColor(R.color.letter_grey_deep_12);
        final int defaultFillColor = res.getColor(R.color.col_app);
        final int defaultOrientation = 0;
        final int defaultStrokeColor = res.getColor(R.color.letter_grey_deep_12);
        final float defaultStrokeWidth = 0;
        final float defaultRadius = res.getDimension(R.dimen.dp03);
